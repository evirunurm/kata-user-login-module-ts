...
describe('User Service Login', () => {
    ...
    describe('Dummy Session Manager', () => {
    ...
    describe('Fake Session Manager', () => {
        it('should log a user if login action is successful', () => {
            ...
            const arrayLength=service.getLoggedUsers().length
    ...
    describe('Spy On Session Manager', () => {
